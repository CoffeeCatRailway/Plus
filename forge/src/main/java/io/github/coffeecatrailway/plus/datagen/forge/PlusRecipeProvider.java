...
{
    public PlusRecipeProvider(DataGenerator arg)
    {
        super(arg);
    }
...
//        this.sawBench(Ingredient.of(ItemTags.PLANKS), Items.STICK, 2).unlocks("has_planks", has(ItemTags.PLANKS)).save(consumer, Plus.getLocation("sticks_from_saw_bench"));
//        this.sawBench(Ingredient.of(ItemTags.LOGS), Items.STICK, 12).unlocks("has_logs", has(ItemTags.LOGS)).save(consumer, Plus.getLocation("sticks_logs_from_saw_bench"));
//
...
//        this.sawBench(Ingredient.of(log), strippedLog).unlocks("has_log", has(log)).save(consumer, Plus.getLocation("stripped_" + woodName + "_log_from_saw_bench"));
//        this.sawBench(Ingredient.of(wood), strippedWood).unlocks("has_wood", has(wood)).save(consumer, Plus.getLocation("stripped_" + woodName + "_wood_from_saw_bench"));
//        this.sawBench(Ingredient.of(logTag), planks, 6).unlocks("has_logs", has(logTag)).save(consumer, Plus.getLocation(woodName + "_planks_from_saw_bench"));
//        this.sawBench(planksIngredient, stairs).unlocks("has_planks", has(planks)).save(consumer, Plus.getLocation(woodName + "_stairs_from_saw_bench"));
//        this.sawBench(planksIngredient, slab, 2).unlocks("has_planks", has(planks)).save(consumer, Plus.getLocation(woodName + "_slab_from_saw_bench"));
//        this.sawBench(planksIngredient, fence).unlocks("has_planks", has(planks)).save(consumer, Plus.getLocation(woodName + "_fence_from_saw_bench"));
//        this.sawBench(planksIngredient, fenceGate).unlocks("has_planks", has(planks)).save(consumer, Plus.getLocation(woodName + "_fence_gate_from_saw_bench"));
//        this.sawBench(planksIngredient, button, 2).unlocks("has_planks", has(planks)).save(consumer, Plus.getLocation(woodName + "_button_from_saw_bench"));
//        this.sawBench(planksIngredient, pressurePlate).unlocks("has_planks", has(planks)).save(consumer, Plus.getLocation(woodName + "_pressure_plate_from_saw_bench"));
//        this.sawBench(planksIngredient, door, 2).unlocks("has_planks", has(planks)).save(consumer, Plus.getLocation(woodName + "_door_from_saw_bench"));
//        this.sawBench(planksIngredient, trapDoor, 2).unlocks("has_planks", has(planks)).save(consumer, Plus.getLocation(woodName + "_trapdoor_from_saw_bench"));
//        this.sawBench(planksIngredient, sign, 2).unlocks("has_planks", has(planks)).save(consumer, Plus.getLocation(woodName + "_sign_from_saw_bench"));
//    }
//
